...
IPMI:
      --profile <PATH>          Path to BMC JSON profile (default: ./profile.json)
...
pub struct Args {
    ...
    // === IPMI ===
    /// Path to BMC JSON profile (default: ./profile.json)
    #[arg(long, help_heading = "IPMI")]
    pub profile: Option<String>,

    /// Log ipmitool commands without executing them
    #[arg(long, help_heading = "IPMI")]
    pub dry_run: bool,
